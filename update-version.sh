...
yarn workspace @flashcatcloud/mobile-react-native-apollo-client pack
yarn workspace @flashcatcloud/mobile-react-native-webview pack
yarn workspace @flashcatcloud/react-native-internal-testing-tools pack
